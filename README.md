...
-   **HTML Semântico:** Uso correto de tags (`<header>`, `<section>`, `<footer>`) para melhorar a acessibilidade e o ranqueamento nos motores de busca (SEO).
